...
public class StudentsAcademic extends tableLoader {
    DateFormat dateFormat = new SimpleDateFormat("MM/dd/YY");
    Date date = new Date();
    Calendar cal = Calendar.getInstance();

    public StudentsAcademic() {
        initComponents();
        model = (DefaultTableModel) table.getModel();
        setTitle("acadamic students");
        ImageIcon icon;
        icon = new ImageIcon("src\\image\\icon.png");
        setIconImage(icon.getImage());
        professionindex = 2;
        filelocation = "src\\data\\FILE_Students_Academic.txt";
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(0, 318, 957, 270);

        SearchLabel.setText("Search a student:");
        getContentPane().add(SearchLabel);
        SearchLabel.setBounds(510, 270, 110, 45);
        ...
        ApplyButton.setBounds(710, 280, 59, 23);
        ...
        StopFilteringButton.setBounds(780, 280, 120, 23);
        ...
        AddButton.setBounds(10, 290, 100, 23);
        ...
        RemoveButton.setBounds(130, 290, 120, 23);
        ...
        FunctionsLabel.setBounds(0, 266, 118, 17);

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel1.setText("Date:");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(740, 0, 100, 40);
